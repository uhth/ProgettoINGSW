...
<div class="container my-5 text-center" style="max-width: 580px;">
    ...
    <p class="lead">Scegli, in base al peso, la spedizione assicurata che si adatta alle tue esigenze. </p>
      ...
      <div class="container">
        <div class="row">
                    ...
                    <div id="divLogin" class="modal">
                        <form class="modal-content animate" action="/loginServiceAssicurata" method="post">
                    ...
                    <div id="divRegister" class="modal">
                        <form class="modal-content animate" action="/iscrizioneServiceAssicurata" method="post">
                            <div class="imgcontainer">
