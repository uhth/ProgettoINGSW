      ...
      <div class="container">
        <div class="row">
				   ...
				   <div class="col text-center">
				      <p class="p">Nomina Corriere</p>
						<div class="richiesta">
							<form  method="post" action="aggiuntaCorriere">
									  <div class="form-group">
									    <label for="formCorriere"></label>
									    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="es. mario_rossi@gmail.com" name="richiestaAggiuntaCorriere">
								 	 </div>
								  <br>								  										  
