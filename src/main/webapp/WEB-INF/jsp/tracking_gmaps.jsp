    ...
    <header class="showcase">
        ...
        <div class="showcase-content">
            <h1>Inserisci il codice della tua spedizione</p>
                <input type="text" id="tracking_box" placeholder="Inserisci numero di tracking" name="track_box">
                <a href="/" class="btn btn-xl" id="button_procedi"> PROCEDI <i class="fas fa-chevron-right btn-icon"></i>
                </a>
                
                <div id="map"></div>

                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPTnpjJwZ-Fv9PUkiAQgEb6GcP5ZaLhSQ&callback=initMap&libraries=&v=weekly" async></script>
          </div>
    </header>
